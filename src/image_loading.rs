...
impl WebmFrame {
    ...
    pub fn save_as_file(&mut self, filename: &str) {
        self.to_rgba();
        
        let image_opt: Option<ImageBuffer<Rgba<u8>, Vec<u8>>> = ImageBuffer::from_raw(self.width as u32, self.height as u32, self.buffer.clone());
